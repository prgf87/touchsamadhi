  ...
  return (
    <div id="about" className="w-full z-[2]">
      <div className="grid grid-cols-1 max-w-[1200px] text-center mx-auto text-sm p-2">
        <div>
          <p className="pt-2 pb-2 text-transparent bg-clip-text bg-gradient-to-r from-gray-100 to-slate-300">
          ...
          <p className="md:text-2xl pt-2">Asheville, North Carolina, U.S.A</p>
        </div>
      </div>
    </div>
  );
