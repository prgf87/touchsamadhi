...
const Listen = () => {
  return (
    <div className="h-[100px] bg-cover bg-white/30 items-center text-gray-200 px-4">
      <div className="grid grid-cols-3 sm:grid-cols-5 text-center gap-2 md:gap-20 pt-1">
